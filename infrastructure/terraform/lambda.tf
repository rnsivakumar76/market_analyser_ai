...
resource "aws_lambda_function" "api" {
  ...
  environment {
    variables = {
      ...
      FRONTEND_URL          = var.domain_name != "" ? "https://${var.domain_name}" : "https://${aws_cloudfront_distribution.frontend_new.domain_name}"
      GOOGLE_REDIRECT_URI   = var.domain_name != "" ? "https://${var.domain_name}/api/auth/callback" : "https://${aws_cloudfront_distribution.frontend_new.domain_name}/api/auth/callback"
      LOG_LEVEL             = "INFO"
    }
  }
